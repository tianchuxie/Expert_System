    ...
    function openLocalSave(){
        ...
        if (flagACS === null) {
            ...
            window.localStorage.setItem("ExpertJSON" , JSON.stringify(expertAcsJSON));
    ...
    function sendBackToExpert() {
        var formHTML = '<form id="sendForm" action="../app.html" method="GET"><input type="hidden" id="jsonString" name="jsonString" /><input type="submit" /></form>';
