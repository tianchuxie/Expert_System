...
var Runner = (function($) {
    ...
    var Variable = (function($) {
        ...
        var SingleValue = (function($) {return function(/* string */ question, /* Array<string> */ possible) {
            ...
            /**
             * Logs the value of this variable. ONLY FOR USE IN TESTING!
             */
            this.log = (function($) {return function() {
                $.c(0);
                console.log(question + ": " + (state == StatusValue.Known ? JSON.stringify(this.getValueString()) : "UNKNOWN"));
            };})($.m("log", 2));
        };})($.m("SingleValue", 2));
        ...
        var MultipleValue = (function($) {return function(/* string */ question, /* Array<string> */ possible) {
            ...
            /**
             * Logs the values of this variable. ONLY FOR USE IN TESTING!
             */
            this.log = (function($) {return function() {
                $.c(0);
                console.log(question + ": " + (state == StatusValue.Known ? JSON.stringify(this.getValueStrings()) : "UNKNOWN"));
            };})($.m("log", 2));
        };})($.m("MultipleValue", 2));
        ...
        var Real = (function($) {return function(/* string */ question, /* Array<RealRange> */ ranges) {
            ...
            this.log = (function($) {return function() {
                $.c(0);
                console.log(question + ": " + (state == StatusValue.Known ? JSON.stringify(this.getValue()) : "UNKNOWN"));
            };})($.m("log", 2));
        };})($.m("Real", 1));
        ...
        return {
             ...
             * Checks the type and creates a variable based on that.
             */
    ...
    var VariableList = (function($) {return function(identifiers) {
        ...
        /**
         * Logs all the variables. SHOULD ONLY BE USED IN TESTING!
         */
        this.log = (function($) {return function() {
    ...
    var evaluateConsequent = (function($) {return function(consequent) {
        ...
        switch (v.type) {
            case DataType.MultipleValue:
                $.c(1);
                v.setKnown(consequent.identifier);
                for (var i = 0; i < consequent.values.length; i++) {
                    $.c(2);
                    v.setValue(consequent.values[i]);
                }
                return;
            case DataType.SingleValue:
            case DataType.YesNo:
    ...
    var obtain = (function($) {return function(/* int */ identifier, /* function */ cb) {
        ...
        if (modifiers.length > 0) {
            ...
            evaluateRule(new Queue(modifiers), function() {
                if (v.status() == StatusValue.Known)
                    cb();
                else if (v.type == DataType.MultipleValue) {
                    v.setKnown();
                    cb();
                }
                else {
    ...
    var run = (function($) {return function(kb) {
        ...
        if (kb) {
            ...
            try {
                ...
                alert("Knowledge base is invalid!");
                return;
            }
    ...
    return {
         ...
         */
        runLocalFile: (function($) {return function() {
            $.c(0);
            if(running) {
                $.c(1);
                throw "System is already running.";
