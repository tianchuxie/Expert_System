...
var Display = (function() {
    ...
    return {
        ...
        SingleValue: function(/* string */ name, /* string */ value, /* function */ cb) {
            ...
            getLogDiv().innerHTML += "<br><br><p>(Press Space Bar or Click Continue button to get the next question)</p>";
...
//            console.log(holder.getMsg());
            ...
            getLogDiv().innerHTML += "<p>Please click Next Case button if you want to repeat the above with another person</p> <p>Or Close your browser if you are done</p>";
